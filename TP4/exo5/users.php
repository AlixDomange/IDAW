...
switch($_SERVER['REQUEST_METHOD']) {
    ...
    case 'GET' : //Obtenir tous les utilisateurs
        ...
        echo '{ "data" : [{"id":"2","name":"Alix Domange","email":"alix.domange@etu.imt-nord-europe.fr"},{"id":"3","name":"Hugo Joly","email":"hugo.joly@etu.imt-nord-europe.fr"},{"id":"4","name":"Baptiste Gratens","email":"baptiste.gratens@etu.imt-nord-europe.fr"},{"id":"8","name":"Louise Bécu","email":"louise.becu@etu.imt-nord-europe.fr"},{"id":"18","name":"Léa Ta","email":"lea.tamboise@etu.imt-nord-europe.fr"},{"id":"57","name":"hh","email":"hh"}]}';
        exit();
    case 'POST' : //Create
